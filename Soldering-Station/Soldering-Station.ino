...
**********************************************************************************************************************
MCU used     : Atmega328p
Descriptoon  : A simple soldering station is designed with an intension to be an addon to the platino unit for the 
               weller tip. This soldering device can be used to heat up the soldering bit to a temperature ranging 
               from 50 – 450 degree Celsius and also to check the temperature of the soldering bit.
***********************************************************************************************************************/
